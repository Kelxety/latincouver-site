...
import logomini from '../../assets/images/minilogo.png';
...
import {
  fetchUser,
  userStore,
} from '../../constants/api/services/userService';
import { useQuery } from 'react-query';
import { ApiResponse } from '../../constants/interface/Response';
...
const TopNavbar = () => {
  ...
  const { user, email, addUser } = userStore();
  const {
    data: userData,
    isLoading,
    isError,
