...
import { mdiFacebook, mdiGooglePlus, mdiTwitter } from "@mdi/js";
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="d-flex align-items-center flex-wrap mb-3">
                    <h5 className="font-weight-normal mb-0 mb-md-1 mb-lg-0 mr-3">
                      $22.736
                    </h5>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="progress">
                          <div
                            className="progress-bar bg-danger w-1/3"
                            style={{ width: "20%" }}
                            role="progressbar"
                            aria-valuenow={35}
                            aria-valuemin={0}
