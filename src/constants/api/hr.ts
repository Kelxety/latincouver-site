...
export const HR_VOLUNTEERING_HOUR: string =  `${hr}/volunteering-hour/`
export const HR_VOLUNTEERING_SCHEDULE: string =  `${hr}/volunteering-schedule/`

//  Emergency Contact
export const HR_EMERGENCY_CONTACT: string =  `${hr}/emergency-contact/`
// Departments
